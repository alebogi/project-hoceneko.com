...
class BaseController extends Controller
{
    ...
    public function index(){
        ...
        $data = [
            'objave' => $objavaModel->orderBy('br_prijavljenih_clanova', 'DESC')->findAll(3),
                ];
        $this->prikaz('pocetna',$data);
    }
    ...
    */
     ...
     */
     public function profil($id){
        $korisnikModel=new KorisnikModel();
        $drugiKorisnik=$korisnikModel->find($id);
        $this->prikaz('pregledProfila', ['drugiKorisnik'=>$drugiKorisnik]);
    }
