     ...
     <div class="row registracija justify-content-center">
         ...
         <div class="col-sm-3 col-md-3 col-lg-3">
             ...
             echo form_password(['name' => 'lozinka']);
                   ...
                   //odavde uzeto
                  /* $str = "pocetna";
                   echo("<input class='btn btn-sm btn-info' onmousedown='storeActiveNav($str)' type='submit' value='Registruj se'/>");
         ...
         <?php 
         //ovde dodato
         echo("Da li se slazete sa "); ?>
         
         <a href="#" onclick="usloviKoriscenja()">&nbsp; uslovima koriscenja &nbsp;</a>
        ...
        echo("aplikacije?");
         ...
         echo("<br>");
          ...
          echo form_dropdown('saglasnost',$opcije,'Da');
          echo("<br><br>");
