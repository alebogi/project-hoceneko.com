...
class Admin extends BaseController
{
    ...
    public function potvrdiPrijavu($idOPri){
        ...
        //Prihvatamo nekoga samo ako je ostalo dovoljno mesta
        $objavaModel = new ObjavaModel();
        $obj = $objavaModel->find($idObjave);
        if($obj->br_prijavljenih_clanova == $obj->br_potrebnih_clanova){
            $this->session->set('porukaGreska', "Ne mozete prihvatiti osobu jer su vec popunjena sva mesta!");
           return redirect()->to(site_url("Admin/prikaziPrijave/$idObjave"));
        }
        ...
        return redirect()->to(site_url("Admin/objava/$idObjave"));
