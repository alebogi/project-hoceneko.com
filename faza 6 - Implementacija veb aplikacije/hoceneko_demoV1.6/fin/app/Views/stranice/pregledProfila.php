                ...
                <div class="row likeWrapper justify-content-center">
                    ...
                    ?>
                     <?php 
                        $session = session();
                        if(!empty($session->get('korisnik'))){
                            echo  anchor("$controller/ocenaPozitivna/{$drugiKorisnik->idKor}", "Pozitivno",'class="btn btn-sm btn-light"');
                         } 
                      ?> 
                   &nbsp;&nbsp;&nbsp;
                      <?php 
                             $session = session();
                              if(!empty($session->get('korisnik'))){
                                  echo anchor("$controller/ocenaNegativna/{$drugiKorisnik->idKor}", "Negativno",'class="btn btn-sm btn-light"');
                               } 
                        ?> 
                    &nbsp;&nbsp;&nbsp;
